...
function AccountProfile({user, btnTitle}:Props){
    ...
    const onSubmit = async (values: z.infer<typeof UserValidation>) =>{
        ...
        await updateUser({username:values.username, bio:values.bio,name:values.name,image:values.profile_photo,userId:user.id,path:pathname})

        if(pathname==="/profile/edit"){router.back()}else{
            router.push("/")
        }
    }
